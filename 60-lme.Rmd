...
### Relation to Generalized Method of Moments (GMM)
Moment matching estimators are more general than likelihood based estimators in that assuming the likelihood implies all moments are assumed, where as in GMMs, not all moments are assumed. 
For GMM estimators in R, see the __gmm__ package. 
